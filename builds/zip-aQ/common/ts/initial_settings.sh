...
# Copy kernel files
cp /tmp/ts/system2/sbin/spa /system/sbin
cp /tmp/ts/system2/init.ts.rc /system
cp /tmp/ts/system2/sbin/ts-kernel.sh /system/sbin
cp /tmp/ts/system2/sbin/init.spectrum.sh /system/sbin
cp /tmp/ts/system2/init.spectrum.rc /system
chmod 755 /system/sbin/spa
chmod 755 /system/sbin/ts-kernel.sh
chmod 755 /system/sbin/init.spectrum.sh
chmod 755 /system/init.spectrum.rc
chmod 755 /system/init.ts.rc
